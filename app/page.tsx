...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col bg-white text-black items-center justify-center space-y-5 p-24 font-roboto">
      <Nav />
      <div className="grid grid-cols-2 items-center justify-center space-x-16 bg-slate-600 text-white rounded-2xl p-5 ml-10 mr-10">
        ...
        <form className="flex flex-col justify-center text-black space-y-5 p-10">
          <label className="text-white text-left">Enter your item:</label>
          <input className="p-3 rounded-sm"></input>
          <label className="text-white text-left">How much are you going to store?</label>
          <input className="p-3 rounded-sm" type="number"></input>
